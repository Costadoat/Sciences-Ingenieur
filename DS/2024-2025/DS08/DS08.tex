...
$$\Omega(\infty) = \lim_{p \to 0} p \cdot \Omega(p) = \frac{K \cdot k_2 \cdot h}{k_2 \cdot h \cdot k_{ri} \cdot f} = \frac{K}{k_{ri} \cdot f}= \frac{0.115}{0.5 \cdot 4\cdot 10^{-4}}= \frac{1150}{2}=575rad\cdot s^{-1}$$
...
Sur la figure \ref{fig12}, on voir que l'écart relatif est de :
\begin{itemize}
 \item $\dfrac{0.03}{3}=1\%$ à t=1ms,
 \item $\dfrac{0.09}{40}=0.2\%$ à t=30ms
\end{itemize}

L'écart maximal est donc de 1\%.}
...
\reponse{3}{}{Si on place les gabarits de la réponse attendue à partir des données du cahier des charges, on remarque que seule la réponse avec anticipation est conforme aux exigences. L'autre ne respecte pas les <5ms.}
...
\includegraphics[width=0.9\linewidth]{img/doc_rep2_cor_1.pdf}
\includegraphics[width=0.9\linewidth]{img/doc_rep2_cor_2.pdf}
\includegraphics[width=0.9\linewidth]{img/doc_rep2_cor_3.pdf}
\end{center}}
...
\end{center}}{\begin{center}
\includegraphics[width=0.9\linewidth]{img/doc_rep3_cor.pdf}
\end{center}}
