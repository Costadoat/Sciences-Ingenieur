...
\question{En utilisant l'hypothèse de roulement sans glissement $\left(\overrightarrow{V_{I,S_2/R_0}}=\vec{0}\ et\ \overrightarrow{V_{J,S_3/R_0}}=\vec{0}\right)$ ainsi que le résultat de la question 2, établir la relation entre $V$, $\omega_{10}$, $\omega_{21}$ et les constantes $L$ et $R$.}
