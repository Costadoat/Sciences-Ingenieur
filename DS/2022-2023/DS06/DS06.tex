...
Donc, $\overrightarrow{\delta}(G_3,3/0)=-B_3\dot{\theta}_3\dot{\theta}_2\overrightarrow{x_2}+B_3\ddot{\theta}_3\overrightarrow{y_2}+A_3\ddot{\theta}_2\overrightarrow{z_2}$}
