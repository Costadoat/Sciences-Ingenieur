...
$$\Delta \theta_{1y} = \dfrac{u_f^{\text{max}} - u_f^{\text{min}}}{L} \approx \dfrac{0,2 + 0,3}{0,3\cdot 10^{3}} \approx 1,7\cdot 10^{-3}\text{rad} $$
...
\begin{itemize}
 ...
 \item $pes\rightarrow 3$ (poids de la pièce 3).
\end{itemize}}

%7
\reponse{4}{}{$\Sigma\overrightarrow{M}(G_3,ext \rightarrow \Sigma)=\overrightarrow{M}(G_3,pes \rightarrow 3)+\overrightarrow{M}(G_3,0 \rightarrow 1)=L_{01}\cdot\overrightarrow{x_1}+M_{01}\cdot\overrightarrow{y_1}+N_{01}\cdot\overrightarrow{z_1}$.}
...
Donc, $\overrightarrow{\delta}(G_3,3/0)=-B_3\dot{\theta}_3\dot{\theta}_2\overrightarrow{x_2}+B_3\ddot{\theta}_3\overrightarrow{y_2}+A_3\dot{\theta}_2\overrightarrow{z_2}$}
...
%11
\reponse{3}{}{Si on veut $M_{01}(t)$ faible, alors $\sin\theta_2(t)$ doit être faible.\\Si on veut $N_{01}(t)$ faible, alors $\dot{\theta}_2(t)$ doit être faible.}
