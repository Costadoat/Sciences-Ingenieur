...
De même, 
$\vec{z'_2}=sin\alpha\cdot sin\theta_2\cdot\vec{x_1}-sin\alpha\cdot cos\theta_2\cdot\vec{y_1}+cos\alpha\cdot\vec{z_1}$
}
...
$\vec{z_S}=sin\theta\cdot sin\psi\cdot\vec{x_0}-sin\theta\cdot cos\psi\cdot\vec{y_0}+cos\theta\cdot{z_0}$}
...
Fonction d'ordre 2 et de classe 1.
...
$K_i=\dfrac{0.14}{4\cdot 5\cdot 0.044}\approx\dfrac{3}{4\cdot 5}\approx\dfrac{3}{20}\approx 0.15$

$\omega_0=\sqrt{\frac{0.15\cdot 5}{0.14\cdot 0.044}}=\sqrt{\frac{5}{0.044}}\approx 10.5rad.s^{-1}$

Donc, $tr_{5\%}=\dfrac{5}{10.5}\approx 0.5s$
}
...
$log(K)=3.5$, donc $K=10^3.5=1000*30=30000$
}
...
\end{center}
Le temps de réponse est de $0.45s$.
}
