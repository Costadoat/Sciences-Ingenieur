...
\reponse{4}{}{La durée d'un cycle est $d_{cycle}=20\cdot d_t+3\cdot d_{ns}+1\cdot d_{nc}=20\cdot6+3\cdot4+1\cdot 10=120+12+20=142 minutes=1heure22min$.}
...
\reponse{3}{}{
$G$ est en $V^{-1}\cdot rad\cdot s^{-1}=A.N^{-1}.m^{-1}=A.kg^{-1}.m^{-2}.s$
