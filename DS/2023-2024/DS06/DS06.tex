...
\reponse{0}{\begin{center}\includegraphics[width=0.8\linewidth]{img/dr02}\end{center}}{\begin{center}\includegraphics[width=0.8\linewidth]{img/dr02_cor}\end{center}}

\ifdef{\public}{\newpage}

\reponse{0}{\begin{center}\includegraphics[width=0.5\linewidth]{img/fig11}\end{center}}{\begin{center}
...
\reponse{0}{\begin{center}\includegraphics[width=0.5\linewidth]{img/dr04}\end{center}}{\begin{center}\includegraphics[width=0.5\linewidth]{img/dr04_cor}\end{center}}
