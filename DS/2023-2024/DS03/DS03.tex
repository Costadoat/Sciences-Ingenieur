...
\reponse{5}{}{$\tau_1=\dfrac{R\cdot J}{k_v\cdot k_i}$, $\tau_2=\dfrac{L\cdot J}{k_v\cdot k_i}$ et $\tau_3=\dfrac{K_1\cdot R_t\cdot K_{eq}}{k_v\cdot k_i}$ }
...
\reponse{4}{
\begin{center}
\resizebox{0.9\textwidth}{!}{\input{img/Bode.pgf}}
...
\begin{center}
  \resizebox{0.9\textwidth}{!}{\input{img/Bode_cor.pgf}}
\end{center}
}
