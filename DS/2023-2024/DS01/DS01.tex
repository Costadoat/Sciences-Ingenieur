...
\question{Justifier que $\xi$ est minimum pour $J=3\cdot 10^{-6}kg\cdot m^2$.}
...
$\Omega_m(p)=\dfrac{4}{350}\cdot\dfrac{p}{\left(350+p\right)^2}+6\cdot\dfrac{1}{\left(350+p\right)^2}-\dfrac{4}{350}\cdot\dfrac{}{p}+\dfrac{2}{p^2}$
...
\reponse{2}{}{
$\omega_m(t)=u\cdot (1-t\cdot a)\cdot e^{-at}+v\cdot e^{-at}-w+z\cdot t$
}
...
\reponse{4}{}{$w\approx -0.01$ et $z\cdot t$}
