...
\reponse{2}{}{$R_T=(C_R+sin\theta)Mg+0.5\cdot\rho A_p\cdot C_D\cdot v^2$}

\reponse{4}{}{Sur la figure, on trouve $R_T=\alpha\cdot v^2+R_{T0}$

Avec $\alpha=\dfrac{17-2.5}{80}=\dfrac{14.5}{80}\approx 0.2$,
donc $0.5\cdot\rho\cdot A_p\cdot C_D=0.2$, donc $A_p\cdot C_D=\dfrac{0.2}{0.5\cdot 1.3}=\dfrac{0.2}{0.65}\approx 0.3m^2$}
...
\reponse{6}{}{$\overrightarrow{CD}+\overrightarrow{DE}+\overrightarrow{EF}+\overrightarrow{FC}=\vec{0}$
...
\reponse{4}{}{D'après la figure \ref{fig13}, on peut approximer $Mf=k\cdot\Delta y$ avec $k=\frac{21}{0.02}$
