...
\posetafigure{fig13}{0.7}{Norme du moment de freinage $M_f$ pour $v=25km\cdot h^{-1}$}
...
$\vec{M}_{O,\vec{f}_L}=-\gamma\cdot r\cdot \omega\cdot B^2\cdot e\cdot \vec{z}_2\int_{r=R_1}^{r=R_2} r^3\cdot dr\int_{\theta=0}^{\theta=\alpha}d\theta=-\gamma\cdot r\cdot \omega\cdot B^2\cdot e\cdot \vec{z}_2\left[\dfrac{r^4}{4}\right]_{r=R_1}^{r=R_2} \alpha=-\gamma\cdot r\cdot \omega\cdot B^2\cdot e\cdot  \alpha\dfrac{R^4_2-R^4_1}{4}\cdot \vec{z}_2$
...
$f^2 = (-e\cdot sin\theta_3+g\cdot sin\theta_5)^2+(-e\cdot cos) + g\cdot cos\theta_5)^2$

$-f^2+e^2+g^2-2\cdot e\cdot g\cdot cos(\theta_3-\theta_5)=0$
}
...
\reponse{4}{}{$K_{CAN}=\dfrac{N_{max}}{V_{max}}=\dfrac{2^n}{V_{max}}=\dfrac{2^{10}}{2.2}=\dfrac{1024}{2.2}\approx 500 inc\cdot V^{-1}$
