...
On identifie un second ordre avec $20\cdot log(K)=60$, donc $K=1000$. $\omega_0=100rad\cdots^{-1}$. $\xi=1$ car la valeur de la courbe est $54rad\cdot s^{-1}$ pour $\omega=\omega_0$, soit $6rad\cdot s^{-1}$ en dessous de l'asymptote. 
}
