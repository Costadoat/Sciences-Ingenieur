...
\begin{figure}[!ht]
 \centering \includegraphics[width=0.4\linewidth]{img/td02_07}
...
\begin{figure}[!ht]
 \centering \includegraphics[width=0.7\linewidth]{img/td02_08}
...
On veut faire un virage de $90^\circ$, donc l'intégrale de $\omega_{10}(t)$ (aire sous la courbe) vaut $90^\circ=\dfrac{\pi}{2}rad$ :

\[
  \dfrac{\pi}{2} = \int_{0}^{t_4} \omega_{10}(t)\,\mathrm{d}t
...
$t_3 = \dfrac{\dfrac{\pi}{2}}{\omega_{10max}}$

$t_4 = t_2 + t_3 = \dfrac{\omega_{10max}}{\gamma_{10}} + \dfrac{\dfrac{\pi}{2}}{\omega_{10max}}$}
...
Donc, $|i_m|=\frac{m_s.g.R_m.R_p}{2.K_i.R_r}=\frac{78.10.20.38.10^{-3}}{2.1.30}=78.10.38.10^{-3}\approx 30A.$}
...
Donc, $\frac{T}{\tau_e}\simeq\frac{3.0,3}{48-36}\simeq\frac{0,9}{12}\simeq 0,075$.}
