...
\begin{center}
 $\dfrac{Vc(p)}{U(p)}=\dfrac{\dfrac{R\cdot r\cdot K_t}{R\cdot f +K_e\cdot K_t}}{1+\dfrac{R\cdot J+L\cdot f}{R\cdot f +K_e\cdot K_t}\cdot p+\dfrac{L\cdot J}{R\cdot f +K_e\cdot K_t}\cdot p^2}$
\end{center}
