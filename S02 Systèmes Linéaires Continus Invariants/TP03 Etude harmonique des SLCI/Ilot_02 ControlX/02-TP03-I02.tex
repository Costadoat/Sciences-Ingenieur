...
\question{Effectuer les opérations précédentes plusieurs fois afin d'obtenir une première ébauche de diagramme de Bode de la fonction de transfert du Control'X.}
...
\question{A partir des résultats précédents, déterminer la forme canonique de la fonction de transfert du Control'X.}
