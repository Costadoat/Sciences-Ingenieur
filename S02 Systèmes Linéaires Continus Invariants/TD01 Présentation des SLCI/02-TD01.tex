...
$P(p)=\frac{K_c.\left(1+\tau_d.p\right).\left(1+\tau.p\right)}{\left((1+K.K_c)+(\tau+K.K_c.\tau_d).p\right)}.\Theta_c(p)$

\paragraph{Question 6:}

$\lim\limits_{t\rightarrow 0}p(t)=\lim\limits_{p\rightarrow +\infty}p.P(p)=\lim\limits_{p\rightarrow +\infty}\frac{K_c.\left(1+\tau_d.p\right).\left(1+\tau.p\right)}{\left((1+K.K_c)+(\tau+K.K_c.\tau_d).p\right)}.\theta_0=\lim\limits_{p\rightarrow +\infty}\frac{K_c.\tau_d.\theta_0.\tau}{1+K.K_c.\tau_d}.p=+\infty$

$\lim\limits_{t\rightarrow +\infty}p(t)=\lim\limits_{p\rightarrow 0}p.P(p)=\lim\limits_{p\rightarrow 0}\frac{K_c.\left(1+\tau_d.p\right).\left(1+\tau.p\right)}{\left((1+K.K_c)+(\tau+K.K_c.\tau_d).p\right)}.\theta_0=\frac{K_c.\theta_0}{1+K.K_c}$
