...
$\epsilon_{vs}=\lim\limits_{p \rightarrow 0} p.\epsilon_v(p)=\lim\limits_{p \rightarrow 0} p.\dfrac{C_v(p)}{1+G_2(p)}=\lim\limits_{p \rightarrow 0} \dfrac{1}{1+G_2(p)}=\dfrac{1}{1+K.K_v.K_1}=\dfrac{1}{1+200.0,01.1,66}=\dfrac{1}{4,3}=\epsilon_{vs}\simeq0,23$

$\Omega_c.K_a-\Omega_v.K_v=0$, si $\Omega_c=\Omega_M$, donc $K_a=\frac{K_v}{\rho}$.
