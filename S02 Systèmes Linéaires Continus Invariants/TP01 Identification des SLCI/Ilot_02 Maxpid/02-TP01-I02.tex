...
On donne la fonction de transfert $\frac{\Omega_m(p)}{U(p)}$ qui lie la vitesse de rotation du moteur à la tension aux bornes du moteur (à retrouver à partir des équations du moteur à courant continu :
\begin{center}
 $\dfrac{\Omega_m(p)}{U(p)}=\dfrac{\dfrac{K_t}{R\cdot f +K_e\cdot K_t}}{1+\dfrac{R\cdot J+L\cdot f}{R\cdot f +K_e\cdot K_t}\cdot p+\dfrac{L\cdot J}{R\cdot f +K_e\cdot K_t}\cdot p^2}$
\end{center}
