...
Lors de la phase de vie \dusysteme\ correspondant à son \og utilisation \fg,

\qeustion{Où se trouve le système (local, atelier, salle de sport,...)}.

\question{A quels éléments extérieurs liés à l'environnement \lesysteme\ est-il confronté lors de la phase de vie \og utilisation \fg ? Ces éléments ont-ils été pris en compte lors de l'étude de la conception \dusysteme\ ? Comment ?}
