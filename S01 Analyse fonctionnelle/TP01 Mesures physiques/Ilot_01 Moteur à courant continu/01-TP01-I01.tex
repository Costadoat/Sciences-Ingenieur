...
\section{Modèle du moteur électrique: tension/vitesse de rotation}
...
\paragraph{Question 6:} \textbf{Mettre en \oe uvre} ce protocole pour des tensions allant de 0V à 12V. Écrire les résultats mesurés dans un tableur et tracer la courbe $\omega_m(t)=f(u_m(t))$. Conclure quant à l'allure de ce tracé.
