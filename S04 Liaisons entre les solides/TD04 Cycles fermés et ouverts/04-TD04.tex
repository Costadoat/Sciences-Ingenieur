...
On cherche à tracer la droite $y(x)=c\cdot x+d$ reliant les points de coordonnées $\left(\begin{array}{c}a+b\\0
...
\begin{center}
$\left\{\begin{array}{l}
\alpha=\theta\pm\arccos\left((\dfrac{u^2+a^2-b^2}{2\cdot u\cdot a}\right)\\\beta=\theta-\alpha\pm\arccos\left(\dfrac{u^2+b^2-a^2}{2\cdot u\cdot b}\right)
\end{array}\right.$
\end{center}
} 
