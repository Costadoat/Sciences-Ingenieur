...
\question{Donner un nom et un numéro à l'ensemble des classes d'équivalence de la plateforme Stewart.}
...
\question{Vous préciserez sous quelle forme l'énergie mécanique est amenée à la plateforme Stewart (par quel composant, caractéristiques,...).}
...
Un modèle numérique de la plateforme Stewart est donné dans le dossier de partage.
