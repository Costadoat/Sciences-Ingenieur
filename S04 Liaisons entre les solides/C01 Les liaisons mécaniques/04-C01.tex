...
Les composantes $X_i$, $Y_i$, $Z_i$, $L_i$, $M_i$, $N_i$ non nulles sont les \textbf{inconnues statiques} de  $l_i$.
la liaison
...
Donc,
  \begin{math}
	L_i.\omega_xi+M_i.\omega_yi+N_i.\omega_zi+X_i.V_xi+V_yi.v_i+V_zi.w_i=0
  \end{math}
...
\begin{center}
  \begin{math}
	...
	\left\{V_{i(S_2/S_1)}\right\}=\left\{ \begin{array}{cc} \omega_xi & 0 \\ 0 & 0 \\ 0 & 0 \end{array}\right\}_O
  \end{math}
\end{center}
}}
