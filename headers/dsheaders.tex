...
\DeclareFloatingEnvironment[
  fileext=lor,
  listname={Liste des documents réponse},
  name=DR,
  placement=htbp,
]{reponsedoc}

% Style du caption : comme figure, sans trait
\captionsetup[reponsedoc]{
  position=bottom,    % titre en bas
  labelfont=bf,       % "Réponse 1" en gras (comme Figure 1)
  skip=6pt
}
