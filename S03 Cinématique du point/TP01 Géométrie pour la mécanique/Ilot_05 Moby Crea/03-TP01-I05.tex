...
\question{Écrire les vecteurs $\overrightarrow{•}ightarrow{AB}$, $\overrightarrow{AC}$ et $\overrightarrow{BC}$ dans les bases respectives $B_5(\overrightarrow{x_5},\overrightarrow{y_5},\overrightarrow{z_5})$, $B_0(\overrightarrow{x_0},\overrightarrow{y_0},\overrightarrow{z_0})$ et $B_6(\overrightarrow{x_6},\overrightarrow{y_6},\overrightarrow{z_6})$. On mesurera $\|\overrightarrow{AB}\|$ et $\|\overrightarrow{BC}\|$ directement sur le système et on prendra $\|\overrightarrow{AC}\|=l(t)$ variable.}

\question{Donner la relation qui existe entre ces vecteurs.}

\question{Projeter cette relation dans la base $B_0(\overrightarrow{x_0},\overrightarrow{y_0},\overrightarrow{z_0})$ afin d'obtenir deux équations scalaires. On fera apparaître les angles $\theta_m$ et $\theta_6=(\overrightarrow{x_0},\overrightarrow{x_6})$.}

\question{A partir de ces équations, déterminer la relation $l(t)=f(\theta_m)$.}
...
\question{Filmer le mouvement de la capsuleuse dans la même vue que celle du schéma cinématique.}
